...
def get_permission(model, codename, name):
    """Create or retrieve a model permission."""
...
def create_role_groups(sender, **kwargs):
    """Create role groups and their required permissions."""
...
def assign_role_group(sender, instance, **kwargs):
    """Assign the user's Django group based on their role."""
